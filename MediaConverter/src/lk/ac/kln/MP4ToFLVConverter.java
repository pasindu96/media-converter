...
public class MP4ToFLVConverter implements Converter{
    ...
    public void Convert(String source, String output) {
        ...
        File mp4ToMFLVConverted=new File(output+"/mp4Toflv-Converted");
        ...
        for(File file:inputFiles){
            ...
            try {
                ...
                encoder.encode(file, new File(mp4ToMFLVConverted+(file.toString().replace(sourceFile.toString(),"//")).replace(".mp4",".flv")), attrs);
